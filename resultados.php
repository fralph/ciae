	...
	<section class="about text-center" id="buscar">
		<div class="container">
			<div class="row">
							...
							<div class="">
								...
								<div class="form-group">
									<div class="col-xs-3">
										...
										<input id="tipo" autofocus type="text" name="type"
											placeholder="Tipo" style="width: 100%; max-width: 600px">
									</div>
									<div class="col-xs-7">
				...
				<button type="button" class="btn btn-link btn-lg">TAREAS</button>
				<button type="button" class="btn btn-link btn-lg">RÚBRICAS</button>
				<button type="button" class="btn btn-link btn-lg">MARCADORES</button>
				<div class="row">

					<div class="col-md-4 col-sm-6">
						<div class="single-result-detail clearfix">

							<div class="result-details" data-toggle="modal"
								data-target="#myModal">

								<h3>Amigos por correspondencia</h3>
								<p style="text-align: left">Autor: Natalia Ávila</p>
								<p style="text-align: left">Género: Carta de presentación
									personal</p>
								<p style="text-align: left">Audiencia: Amigo</p>
								<p style="text-align: left">Duración: 90 min.</p>
								<p style="text-align: left">
									Contiene: <span class="glyphicon glyphicon-film"
										aria-hidden="false"></span> <span
										class="glyphicon glyphicon-book" aria-hidden="false"></span> <span
										class="glyphicon glyphicon-print" aria-hidden="false"></span>
								</p>
								<p style="text-align: left">El producto final es una carta de
									dos párrafos de extensión destinada a un amigo de un curso
									paralelo, de un colegio cercano o de séptimo año, según resulte
									más adecuado a la realidad del colegio</p>
								<div class="col-md-4 col-sm-6">
									<p style="text-align: center">500 Visitas</p>
								</div>
								<div class="col-md-4 col-sm-6">
									<p style="text-align: center">15 Comentarios</p>
								</div>
								<div class="col-md-4 col-sm-6">
									<p style="text-align: center">250 Votos</p>
								</div>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-result-detail clearfix">
								...
								<div class="result-details" data-toggle="modal"
									...
									<h3>Los Mayas</h3>
									<p style="text-align: left">Autor: Agencia de Calidad de la
										Educación</p>
									<p style="text-align: left">Género: Carta de presentación
										personal</p>
									<p style="text-align: left">Duración: 45 min.</p>
									<p style="text-align: left">
										Contiene: <span class="glyphicon glyphicon-book"
											aria-hidden="false"></span>
									</p>
									<p style="text-align: left">El alumno debe escribir un articulo
										con el fín de informar a sus compañeros.</p>
									<div class="col-md-4 col-sm-6">
										<p style="text-align: center">250 Visitas</p>
									</div>
									<div class="col-md-4 col-sm-6">
										<p style="text-align: center">7 Comentarios</p>
									</div>
									<div class="col-md-4 col-sm-6">
										<p style="text-align: center">116 Votos</p>
									</div>
							...
							<div class="col-md-4 col-sm-6">
								<div class="single-result-detail clearfix">
									...
									<div class="result-details" data-toggle="modal"
										...
										<h3>Uso de comas</h3>
										<p style="text-align: left">Autor: Francisco García</p>
										<p style="text-align: left">Género: Gramática</p>
										<p style="text-align: left">Duración: 30 min.</p>
										<p style="text-align: left">Actividad para alumnos de 6to
											básico, sobre el uso de las comas.</p>
										<div class="col-md-4 col-sm-6">
											<p style="text-align: center">98 Visitas</p>
										</div>
										<div class="col-md-4 col-sm-6">
											<p style="text-align: center">2 Comentarios</p>
										</div>
										<div class="col-md-4 col-sm-6">
											<p style="text-align: center">
												13 <br>Votos
	...
	<div id="myModal" class="modal fade" role="dialog">
		<div class="modal-dialog modal-lg">
  		...
  		<div class="alert alert-danger" role="alert">
  				...
  				<span class="sr-only">Error:</span> Debes <a href="#">iniciar
							sesión</a> para descargar el contenido. Si no tienes cuenta <a
							href="http://localhost:8080/moodle/login/signup.php">registrate
							gratis.</a>
					</div>
		<?php }?>
		<?php if($logged){?>
				...
				<a href="">Descargar Marcadores Sugeridos</a>
		<?php }?>
					<h3>Ejemplos</h3>
					...
					<iframe width="560" height="315"
						src="https://www.youtube.com/embed/_LfywvezuVQ" frameborder="0"
